  ...
  return (
    <div className="flex flex-col @md:flex-row overflow-clip rounded-[20px] items-start @md:items-center gap-4 px-6 py-5 justify-between w-full [box-shadow:#FFFFFF_-1px_2px_0px_inset] bg-[#F2F2F2] border border-solid border-[#DEDEDE] antialiased">
      <div className="flex flex-col items-start gap-2">
        ...
        <div className="tracking-[-0.02em] w-fit font-['DM_Sans',system-ui,sans-serif] text-[#0000004D] text-body leading-[1.25rem]">
          {block.description}
        </div>
      </div>
      <div className="flex items-center gap-6">
        ...
        >
          <div className="tracking-[-0.02em] w-fit font-['DM_Sans',system-ui,sans-serif] font-medium text-black text-body leading-[1.25rem]">
            {block.buttonText}
          </div>
        </a>
        <div className="content-center text-center font-['SFPro-Semibold','SF_Pro',system-ui,sans-serif] font-[590] flex justify-center flex-wrap text-[#0000004D] text-body leading-[1.25rem]">
          →
        </div>
      </div>
    </div>
